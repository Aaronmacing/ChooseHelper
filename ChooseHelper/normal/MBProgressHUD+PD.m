...
+ (void)show:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
    ...
    [hud.label setTextColor:[UIColor colorWithRed:255 / 255.0 green:255 / 255.0 blue:255 / 255.0 alpha:1]];
    hud.bezelView.backgroundColor = [UIColor colorWithRed:0 / 255.0 green:0 / 255.0 blue:0 / 255.0 alpha:0.85];
    // 隐藏时候从父控件中移除
