...
//
            ...
            if ([NSString isBlankString:tf2.text]) {
            ...
            if ([NSString isBlankString:tf3.text]) {
            ...
            if (![tf2.text isEqualToString:tf3.text]) {
             ...
             [self showWaiting];
             [[UserRequestServer sharedUserRequestServer] changePWByAccount:self.account.account oldPW:tf1.text newPW:tf2.text success:^{
                [self dismissWaiting];
